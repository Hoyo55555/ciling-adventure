...
const TOWN_HIDE = {
  ...
  /* 抄書鎮 */
  chaoshu: [[15, 11, 1, 3], [18, 11, 1, 3], [11, 14, 1, 3], [20, 7, 1, 3], [21, 11, 1, 3], [22, 13, 1, 3],
    [23, 13, 1, 3], [26, 13, 1, 3], [25, 8, 1, 1]],
  /* 典籍港 */
...
/* ---------------------------------------------------------------
   三大設施的統一外觀
     'hybrid'：補給站與商店換成統一建築（方案甲），道館只在門口掛金匾（方案丙）
     'sign'  ：三種都只掛招牌，草圖完全不動
     'off'   ：完全不加
   道館之所以不換建築，是因為草圖裡的道館本來就是各城鎮的地標
   （注音坡校舍、碑林關城門、鐘塔台大禮堂），換掉反而可惜。
   --------------------------------------------------------------- */
const FACILITY_STYLE = 'hybrid';

/* 哪一個門通往哪一種設施 */
const FACILITY_OF = {
  clinic_h: 'clinic', clinic_c: 'clinic', clinic_o: 'clinic',
  store_h: 'store', store_c: 'store', store_o: 'store',
  c1a: 'gym', lib: 'gym', yard: 'gym', hist: 'gym', aud: 'gym',
};
