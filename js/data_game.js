...
/* ============ 地圖 ============
   舊版地圖（手繪草圖背景＋手工碰撞格）已於 2026-09-25 全部移除，
   原因：出入口看不出來、路不像路、有空氣牆。
   新版地圖改回「一格一個字元」的磚塊地圖，看到什麼就是什麼、碰撞由字元決定，
   一張一張重新設計，放在 js/data_maps_v2.js。
   要翻舊版：git checkout art-maps-v141
   ============================================================ */
const SOLID = new Set();          // 由 data_maps_v2.js 依新的磚塊表填入
const LAYOUTS = {};               // 由 data_maps_v2.js 依序加入
